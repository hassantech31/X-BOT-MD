...
const BOT_INFO = process.env.BOT_INFO || "Hasssan BOT MD;Hassan Tech;https://files.catbox.moe/zuvkdj.jpeg";
const URL = process.env.URL || "https://www.instagram.com/sparky.drip";
const AUDIO_DATA = process.env.AUDIO_DATA || "Hasssan BOT MD;Hassan Tech;https://files.catbox.moe/zuvkdj.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "Tech BOT MD;Hassan tech";
